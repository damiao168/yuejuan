...
Internal, authenticated, shadow-only subjective grading service. It supports the local llama.cpp runtime and DashScope's native generation API. It does not call an OpenAI-compatible vendor endpoint.
